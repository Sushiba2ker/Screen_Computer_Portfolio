<template>
  <div>
    ...
    <div class="content" id="aboutSection" v-if="selectedContent === 'about'">
      <hr />
      <p class="desc">
        Hello there! I'm Bao, a 21-year-old student with a
        passion for Data Engineer. Currently,
        I am a 4th year student at Ho Chi Minh City University of Technology - HUTECH
      </p>
      <p class="desc">
...
export default {
  ...
  methods: {
    ...
    redirectToGitHub() {
      window.open("https://github.com/Sushiba2ker", "_blank");
    },
    redirectToLinkedIn() {
      window.open("https://www.linkedin.com/in/nguyen-bao-9a58b324a/", "_blank");
    },
