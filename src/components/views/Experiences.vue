  ...
  data() {
    return {
      ...
      professionals: [
        ...
        {
          image: "bstar.png",
          company: "BStar Solutions JSC",
          position: "Fresher",
          duration: "September 2021 - September 2022",
          responsibilities: [
            "Participated in an intensive training program on database management and optimization of data pipelines.",
            "Assisted in designing and implementing data management solutions, improving query performance and data storage efficiency, leading to a 30% system performance improvement.",
            "Collaborated with the technical team to optimize data workflows, ensuring smooth and efficient data streams."
          ]
        },
      ],
      organizationals: [
